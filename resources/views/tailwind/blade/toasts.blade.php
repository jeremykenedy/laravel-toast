        ...
        >
            ...
            <div class="p-4 flex items-start gap-3">
                ...
                <template x-if="toast.show_close !== false">
                    <button type="button" @click="dismiss(toast.id)" class="shrink-0 rounded-md p-1 opacity-60 hover:opacity-100 transition-opacity cursor-pointer focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 dark:focus-visible:ring-offset-transparent" :class="{ 'focus-visible:ring-green-500 dark:focus-visible:ring-green-400': toast.type === 'success', 'focus-visible:ring-red-500 dark:focus-visible:ring-red-400': toast.type === 'error', 'focus-visible:ring-amber-500 dark:focus-visible:ring-amber-400': toast.type === 'warning', 'focus-visible:ring-blue-500 dark:focus-visible:ring-blue-400': toast.type === 'info' }" aria-label="{{ __('toast::toast.dismiss') }}">
